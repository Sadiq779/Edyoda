...
--
-- Host: localhost    Database: assignmentmysql
-- ------------------------------------------------------
...
CREATE TABLE `customers` (
  ...
  PRIMARY KEY (`Cnum`),
  KEY `Snum` (`Snum`),
  CONSTRAINT `customers_ibfk_1` FOREIGN KEY (`Snum`) REFERENCES `salespeople` (`Snum`) ON DELETE SET NULL
...
CREATE TABLE `orders` (
  ...
  KEY `Cnum` (`Cnum`),
  KEY `Snum` (`Snum`),
  CONSTRAINT `orders_ibfk_1` FOREIGN KEY (`Cnum`) REFERENCES `customers` (`Cnum`) ON DELETE SET NULL,
  CONSTRAINT `orders_ibfk_2` FOREIGN KEY (`Snum`) REFERENCES `salespeople` (`Snum`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-12-05 20:02:10
